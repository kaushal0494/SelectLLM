...
def main():
    ...
    if training_args.do_predict:
        ...
        subjects = predict_dataset["subject"]
        
        gas = predict_dataset["gold_answer"]
        ge7blms = predict_dataset["auto_answers_maj_gemma-7b_LM"]
        me7blms = predict_dataset["auto_answers_maj_metamath-7b_LM"]
        mi7blms = predict_dataset["auto_answers_maj_mistral-7b-lm_LM"]
        ll7blms = predict_dataset["auto_answers_maj_llama2-7b-lm_LM"]
        ge7bits = predict_dataset["auto_answers_maj_gemma-7b-it_CHAT"]
        ll13bits = predict_dataset["auto_answers_maj_llama2-13b-chat_CHAT"]
        mi7bits = predict_dataset["auto_answers_maj_mistral-7b-inst_CHAT"]
        ...
        if trainer.is_world_process_zero():
            ...
            for index, (item, raw_prediction, sentence, split, subject, true_label, ga, ge7blm, me7blm, mi7blm, ll7blm, ge7bit, ll13bit, mi7bit) in enumerate(zip(predictions, raw_predictions, input_sentences, input_splits, subjects, true_labels, gas, ge7blms, me7blms, mi7blms, ll7blms, ge7bits, ll13bits, mi7bits)):
            #for index, item in enumerate(predictions):
                if is_regression:
                    ...
                    collect_predictions.append([sentence, split, subject, true_label, item_lab, item, raw_prediction, ga, ge7blm, me7blm, mi7blm, ll7blm, ge7bit, ll13bit, mi7bit])
                else:
                    item_lab = label_list[item]
                    true_label = label_list[true_label]
                    collect_predictions.append([sentence, split, subject, true_label, item_lab, item, raw_prediction, ga, ge7blm, me7blm, mi7blm, ll7blm, ge7bit, ll13bit, mi7bit])
        
        header = ["question", "split", "subject", "true_label", "prediction", "raw_predictions", "confidence", "gold_answer", "auto_answers_maj_gemma-7b_LM", "auto_answers_maj_metamath-7b_LM", "auto_answers_maj_mistral-7b-lm_LM", "auto_answers_maj_llama2-7b-lm_LM", "auto_answers_maj_gemma-7b-it_CHAT", "auto_answers_maj_llama2-13b-chat_CHAT", "auto_answers_maj_mistral-7b-inst_CHAT"]
